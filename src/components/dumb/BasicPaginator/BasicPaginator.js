...
class BasicPaginator extends React.Component {
    ...
    render() {
        ...
        const rightGroup = this.createRightGroup({
            page,
            numberOfEndGroupElements,
            numberOfRightGroupElements,
            totalPages
        })
        const endGroup = this.createEndGroup({page, numberOfRightGroupElements, numberOfEndGroupElements, totalPages})
        return (
            <div className={this.className()}>
                <Icon className={this.className('leftArrow')} onClick={this.onPageChange.bind(this, 'prev')}
                      icon={leftArrowIcon}/>
                {startGroup}
                {leftGroup}
                ...
                {rightGroup}
                {endGroup}
                <Icon className={this.className('rightArrow')} onClick={this.onPageChange.bind(this, 'next')}
                      icon={rightArrowIcon}/>
            </div>
        )
    }
